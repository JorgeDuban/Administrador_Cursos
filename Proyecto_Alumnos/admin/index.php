...
<html>
  ...
  <body>
    ...
    <form method="post">
      ...
      <input id="usuario" name="usuario" type="text" placeholder="Ingrese su usuario" pattern="[a-zA-Z0-9]{1,15}" autocomplete="off" required>
      <div class="form-element">
      </div>
      <label for="usuario" class="form-element">Clave:</label>
      <input name="password" type="password" placeholder="Ingrese su contraseña" pattern="[A-Za-z0-9@#$%]{8,20}" title="Una contraseña válida es una cadena con una longitud entre 8 y 20 caracteres, donde cada uno consiste en una letra mayúscula o minúscula, un dígito, o los símboloss '@', '#', '$' y '%'" required autocomplete="off">
      <div class="form-element">
